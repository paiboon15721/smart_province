...
$search_day = $year.$month."31";

//echo "search_day =".$search_day."<br>";
  //$catm_sel = "26000000";
  mysql_query("SET NAMES 'utf8' COLLATE 'utf8_general_ci';");
  
   $strSQL= "select * from tab_news_voice  where expire_news <=".$search_day." and ((catm = ".$catm_sel.") or (catm =".$cc_sel.") or (catm =".$ccaa_sel.") or (catm=".$ccaatt_sel.")) ";
...
<div id="contentpopup">
  <div id="welcome" class="post" style="border-bottom: 0px"> 
    <h1 class="title" style="border-bottom: 1px solid #3B3B3B; padding-bottom: 8px"><img src="images/pr1.gif" width="92" height="67" style="border: 0px">ข่าวเก่า-การแจ้งประชาสัมพันธ์เสียงตามสาย</h1>
	...
	?>
      <tr bgcolor="#A6FFFF"> 
        <td width="36%"><b>รายการข่าว</b></td>
        <td width="17%">วันที่/เวลาที่ส่งข่าว</td>
