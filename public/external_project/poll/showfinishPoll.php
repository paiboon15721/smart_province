        ...
        <div id="template_content_outer">
            ...
            <div id="template_content_inner"> 
            	<div id="template_content">
				 ...
				 <table width="95%" align="center" id="newspaper-b" summary="hisPoll">
                    <thead>
                        <tr>
				...
				$query  = sprintf("SELECT pollID, pollQuestion FROM tab_polls WHERE datevote_end < %s ORDER By pollID ASC", $curDate);
