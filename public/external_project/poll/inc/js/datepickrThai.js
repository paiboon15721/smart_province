...
function datepickr(id, userConfig) {
	...
	function handleMonthClick() {
		...
		var yearThai = currentYearView + 543;
		...
		month.innerHTML = get.month.string(config.fullCurrentMonth) + ' ' + yearThai;
	...
	function initialise(userConfig) {
		...
		month = build('span', { className: 'current-month' }, get.month.string(config.fullCurrentMonth) + ' ' + yearThai);
