...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#show_temple_kowTuRian").fancybox();
				...
				<div class="container">	
					...
					<div class="acc_container">
						<ol>
							<li>กลุ่มทำนา
								<ul>
									<li>ประธานกลุ่ม นายพลชัย สีลาเขต มีสมาชิก 50 คน</li>
									<li>เงินทุนหมุนเวียนในกลุ่ม 35,000 บาท</li>
								</ul>
							</li>
							<li>กลุ่มทำสวน
								<ul>
									<li>ประธานกลุ่ม นางธัญพร นันทา จำนวนสมาชิก 8 คน</li>
									<li>เงินทุนหมุนเวียนในกลุ่ม 20,000 บาท</li>
								</ul>
							</li>
							<li>กลุ่มเย็บผ้า 1
								<ul>
									<li>ประธานกลุ่ม นางสุลัดดา สีลาเขต จำนวนสมาชิก 6 คน</li>
									<li>เงินทุนหมุนเวียนในกลุ่ม 24,000 บาท</li>
								</ul>
							</li>
							<li>กลุ่มเย็บผ้า 2
								<ul>
									<li>ประธานกลุ่ม นางนิยม พุทธา จำนวนสมาชิก 6 คน</li>
									<li>เงินทุนหมุนเวียนในกลุ่ม 24,000 บาท</li>
								</ul>
							</li>
							<li>กลุ่มอนุรักษ์และพัฒนาโค/กระบือ
								<ul>
									<li>ประธานกลุ่ม นายพลชัย สีลาเขต จำนวนสมาชิก 5 คน</li>
									<li>เงินทุนหมุนเวียนในกลุ่ม 24,000 บาท</li>
								</ul>
							</li>
							<li>กลุ่มเลี้ยงไก่พื้นเมือง 1
								<ul>
									<li>ประธานกลุ่ม นายเสนอ หาเรือนทอง จำนวนสมาชิก   5   คน</li>
									<li>เงินทุนหมุนเวียนในกลุ่ม 14,000 บาท</li>
								</ul>
							</li>
							<li>กลุ่มเลี้ยงไก่พื้นเมือง 2
								<ul>
									<li>ประธานกลุ่ม นายสำราญ ศรีทอง จำนวนสมาชิก 10 คน</li>
									<li>เงินทุนหมุนเวียนในกลุ่ม 19,400 บาท</li>
								</ul>
							</li>
							<li>กลุ่มผลิตปุ๋ยอินทรีย์
								<ul>
									<li>ประธานกลุ่ม นายพลชัย สีลาเขต จำนวนสมาชิก 50 คน</li>
									<li>เงินทุนหมุนเวียนในกลุ่ม 35,000 บาท</li>
								</ul>
							</li>
							<li>กลุ่มค้าขาย
								<ul>
									<li>ประธานกลุ่ม นางสุมลฑา ศักดิ์รามินทร์ จำนวนสมาชิก 5 คน</li>
									<li>เงินทุนหมุนเวียนในกลุ่ม 24,000 บาท</li>
								</ul>
							</li>
							<li>กลุ่มร้านค้า
								<ul>
									<li>ประธานกลุ่ม นางอุ่นเรือน ทัศนา จำนวนสมาชิก 5 คน</li>
									<li>เงินทุนหมุนเวียนในกลุ่ม 20,000 บาท</li>
								</ul>
							</li>
						</ol>
					...
					<div class="acc_container">
						<ol>
							<li><a id="show_temple_kowTuRian" href="<?php echo $pathLoadPage; ?>/show_temple_kowTuRian">วัดเขาทุเรียน</a></li>
						</ol>		
					</div>
				</div>
			</div>
