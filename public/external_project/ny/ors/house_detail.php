...
<div id="content">
    ...
    <label for="" class="label_title">เลขรหัสประจำบ้าน</label><label id="hid" class="display_data"><?php echo $_REQUEST['hid'];?></label><br/>
    <label for="" class="label_title">ประเภทบ้าน</label><label id="htype" class="display_data"><?php echo $_REQUEST['htype'];?></label><br/>
    <label for="" class="label_title">ที่อยู่</label><label id="address" class="display_data"><?php echo $_REQUEST['address'];?></label><br/>
    </fieldset>
    <fieldset>
    <legend>ข้อมูลแผนที่</legend>
    <div class="center_box">
    <img src="images/banna.png" />
    </div>
    </fieldset>
