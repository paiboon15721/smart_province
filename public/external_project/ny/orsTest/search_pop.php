...
<script src="js/valid_form.js" type="text/javascript"></script>
...
<div id="tabs">
    ...
    <div id="tabs-2">
        ...
        <select id="sel_aa2" name="sel_aa2" style="width:170px;height:23px;">
        <!--    <option value="">----- อำเภอ -----</option>
            <option value="2601">เมืองนครนายก</option>
            <option value="2602">บางพลี</option>
            <option value="2603">บ้านนา</option>
        ...
        <select id="sel_tt2" name="sel_tt2" style="width:170px;height:23px;">
            <option value="">----- ทุกตำบล -----</option>
        </select>
        </div>
        <div class="input_cond">
        <label for="sel_mm2" class="label_title">หมู่บ้าน</label>
        <select id="sel_mm2" name="sel_mm2" style="width:170px;height:23px;">
            <option value="">---- ทุกหมู่บ้าน ----</option>
        </select>
        </div>
    ...
    <div id="tabs-3">
        ...
        <select id="sel_aa3" name="sel_aa3" style="width:170px;height:23px;">
        <!--    <option value="">----- อำเภอ -----</option>
            <option value="2601">เมืองนครนายก</option>
            <option value="2602">บางพลี</option>
            <option value="2603">บ้านนา</option>
        ...
        <select id="sel_tt3" name="sel_tt3" style="width:170px;height:23px;">
            <option value="">----- ทุกตำบล -----</option>
        </select>
        </div>
        <div class="input_cond">
        <label for="sel_mm3" class="label_title">หมู่บ้าน</label>
        <select id="sel_mm3" name="sel_mm3" style="width:170px;height:23px;">
            <option value="">---- ทุกหมู่บ้าน ----</option>
        </select>
        </div>
        <br/>
