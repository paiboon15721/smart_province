...
<title>แก้ไขผู้เข้าใช้งานระบบ</title></head>
...
<TR>
	<TD>
		...
		<tr height="30">
			...
			<td width="40%" align="left" valign="middle" rowspan="3"><img src="<?php echo $pic; ?>" width="200" /></td>
		</tr>
		<tr height="30">
...
<TR>
	<TD>
		...
		<tr height="30">
			...
			<td width="80%" align="left" valign="middle"><textarea name="txt_add" id="txt_add" cols="80" rows="3" maxlength="250"><?php echo $address_base; ?></textarea></td>
		</tr>
		<tr height="30">
