...
function upload_file(str)
{
	...
	$.get("./Ajax_emp/upload_image.php", { time: n },function(data){ $("#file_upload").html(data); });
}
</script>
<body onload="upload_file(this.value);">
<?php
...
<TR>
	<TD>
		...
		<tr height="30">
			...
			<td width="40%" align="left" valign="middle"><?php echo $EMPADD; ?></td>
		</tr>
		</table>
	</TD>
</TR> 
...
<TR>
	<TD>
		...
		<tr height="30">
			...
			<td width="80%" align="left" valign="middle"><div id="file_upload"></div></td>
		</tr>
