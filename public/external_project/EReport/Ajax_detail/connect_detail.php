			   ...
			   $r_no = $row['r_no'];
				...
				?><tr height='20' valign='middle'>
					...
					<td  align='center'  width="50px"><p>
						<img class='imgclick' src='./images/edit2.gif' alt ="แก้ไขข้อมูล" style="cursor:pointer;cursor:hand;" onClick="load_chronicle('<?php echo $r_no; ?>','<?php echo $date_s; ?>','<?php echo check_time($time_s); ?>','<?php echo $r_type; ?>','<?php echo $r_another; ?>','<?php echo $r_detail; ?>','<?php echo $r_status; ?>','<?php echo $date_e; ?>','<?php echo check_time($time_e); ?>');" />
						<img class='imgclick' src='./images/delete.gif' alt ="ลบข้อมูล" style="cursor:pointer;cursor:hand;" onClick="del_chronicle('<?php echo $r_no; ?>','<?php echo $date_s; ?>','<?php echo check_time($time_s); ?>');"/>
