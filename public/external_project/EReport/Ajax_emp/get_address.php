...
if (!$conn) 
{
	...
	{
		echo "ไม่พบที่อยู่";
		//echo "<textarea name='txt_add' id='txt_add' cols='80' rows='2' maxlength='250'>ไม่พบที่อยู่</textarea>";
	}else{
		echo $add_desc;
		//echo "<textarea name='txt_add' id='txt_add' cols='80' rows='2' maxlength='250' disabled='disabled'>$add_desc</textarea>";
	}
	oci_close($conn);
}
?>