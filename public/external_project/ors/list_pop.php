...
<div id="content" class="content">
    <form id="frm_list_pop">
        ...
        <input type="hidden" id="pop_data" value=""/>
    </form>
    <div id="cond_desc">
        <div><span class="label_title_bold">ผลการค้นหารายการบุคคล</span></div>
        <div><span class="label_title_bold">เงื่อนไข : </span><span class="display_data_head"><?php echo $cond_desc; ?></span></div>
        <div>
        <div class="left"><span class="label_title_bold">เรียงข้อมูลตาม : </span><span class="display_data_head"><?php echo $sort_desc; ?></span></div>
        <div class="right"><span class="label_title_bold" id="total"></span></div>
        </div>
    </div>
    <br/>
    <div id="loading" class="center_box"><img src="images/loading.gif"/></div>
    <p>
    <div id ="details" class="table_pop">
