...
<table cellspacing="0" cellpadding="0"  id="datatable">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align:center;">{{HTML::link($url . '/update/' . $data->image_id, 'แก้ไข', array('class' => 'btn', 'style'=>'width:100px'))}}<br /><br />{{HTML::link($url . '/delete/' . $data->image_id, 'ลบ', array('class' => 'btn'))}}</td>
        </tr>
        @endforeach
    </tbody>
</table>
